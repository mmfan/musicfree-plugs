...
async function jxcxin_mp3(musicId) {
    ...
    //https://apis.jxcxin.cn/api/kugou?apiKey=5bf4ffb10e1cf8f274605fbbf239e1fa
    const desUrl = `https://apis.jxcxin.cn/api/kugou?id=${musicId}&apiKey=5bf4ffb10e1cf8f274605fbbf239e1fa`;
...
async function hifi_mp3(singerName, songName) {
    ...
    let so_url = "https://www.hifini.com/search-" + keyword + ".htm?btwaf=18202802#";
    console.log(so_url);
    // let digest43Result = (await axios_1.default.get(so_url)).data;

    let digest43Result = (await (0, axios_1.default)({
        method: "GET",
        url: so_url,
        xsrfCookieName: "XSRF-TOKEN",
        withCredentials: true,
...
// searchMusic('告白气球', 1).then(console.log);
...
const item =         {
    ...
    artwork: undefined,
    '320hash': '4840fdab1d672c96f8b7b66a438dd1aa',
    sqhash: '3206e5c3880f5e0e47fcd8671449a9d2',
    origin_hash: undefined
  };

  const item1=  {
    id: '32c0f8c1e25a20921c7fac894ebb1bd2',
    title: '晴天',
    artist: '欧阳耀莹',
    album: '欧阳耀莹 Cover合辑',
    album_id: '24181542',
    album_audio_id: 143059440,
    artwork: undefined,
    '320hash': '91fd06b47468804d79fbd112aff6bfb7',
    sqhash: '',
    origin_hash: undefined
  }

  const item2=  {
        id: '7cd5bbb5a067c03f96f2ac913caae5d8',
        title: '晴天 (Live)',
        artist: '旺仔小乔',
        album: '',
        album_id: '',
        album_audio_id: 520078488,
        artwork: undefined,
        '320hash': '',
        sqhash: '',
        origin_hash: undefined
